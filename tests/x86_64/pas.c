...
#define k _p[2]
#define k_columnindex 2
#define gamma _p[3]
#define gamma_columnindex 3
#define Dk _p[4]
#define Dk_columnindex 4
#define v _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 0);
 	...
 	ivoc_help("help ?1 pas /Users/hater/src/modcc/test/pas.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hater/src/modcc/test/pas.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "    SUFFIX pas\n"
  ...
  "}\n"
  "\n"
  "ASSIGNED { gamma FROM 0 TO 1 (MeV) i }\n"
  "\n"
  "STATE {\n"
